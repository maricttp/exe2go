...
<head>
	<link href="./local/resources/assets/css/about.css" rel="stylesheet">

</head>

@section('content')
<div class="about-banner-img">
	<img src="./local/resources/assets/img/about/imb_banner.png">
	<div class="opacity">
		<h1>About</h1>
	</div>
</div>					
	...
	<div class="employee-box">
	    ...
	    <div id="employee" >
	         <div>
	         	...
	         	<p class="employ">Boris Zolotarev</p>
	         ...
	         <div>
	         	...
	         	<p class="employ">Sofija Drecun</p>
	         	<div class="white-line"></div>
	         </div>
