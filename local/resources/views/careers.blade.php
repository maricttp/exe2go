...
<head>
	<link href="./local/resources/assets/css/careers.css" rel="stylesheet">
</head>
@section('content')
	<div class="careers-box">
		<div class="careers">
			<div class="careers-heading">
				<img src="./local/resources/assets/img/careers/imgcareer.png" />
				<h5>We wish you luck.</h5>  
			</div>
			<div class="careers-title">
			 	<h1>Careers</h1>
				<h5>Here you can apply.</h5>
				<h5>Positions</h5>  
			</div>
